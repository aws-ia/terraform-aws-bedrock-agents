...
| <a name="input_breakpoint_percentile_threshold"></a> [breakpoint\_percentile\_threshold](#input\_breakpoint\_percentile\_threshold) | The dissimilarity threshold for splitting chunks. | `string` | `null` | no |
| <a name="input_buffer_size"></a> [buffer\_size](#input\_buffer\_size) | The buffer size. | `string` | `null` | no |
| <a name="input_chunking_strategy"></a> [chunking\_strategy](#input\_chunking\_strategy) | Option for chunking your source data, either in fixed-sized chunks or as one chunk. Valid values: FIXED\_SIZE, HIERARCHICAL, SEMANTIC, NONE. | `string` | `null` | no |
...
| <a name="input_lambda_arn_transformation"></a> [lambda\_arn\_transformation](#input\_lambda\_arn\_transformation) | The ARN of the lambda to use for custom transformation. | `string` | `null` | no |
| <a name="input_level_config_max_tokens"></a> [level\_config\_max\_tokens](#input\_level\_config\_max\_tokens) | The maximum number of tokens that a chunk can contain in this layer. | `string` | `null` | no |
...
| <a name="input_max_tokens"></a> [max\_tokens](#input\_max\_tokens) | Maximum number of tokens to include in a chunk. | `string` | `null` | no |
...
| <a name="input_model_arn"></a> [model\_arn](#input\_model\_arn) | The ARN of the model used to parse documents | `string` | `null` | no |
...
| <a name="input_overlap_percentage"></a> [overlap\_percentage](#input\_overlap\_percentage) | Percentage of overlap between adjacent chunks of a data source. | `string` | `null` | no |
| <a name="input_overlap_tokens"></a> [overlap\_tokens](#input\_overlap\_tokens) | The number of tokens to repeat across chunks in the same layer. | `string` | `null` | no |
...
| <a name="input_parsing_prompt_string"></a> [parsing\_prompt\_string](#input\_parsing\_prompt\_string) | Instructions for interpreting the contents of the document. | `string` | `null` | no |
...
| <a name="input_s3_uri"></a> [s3\_uri](#input\_s3\_uri) | S3 URI for intermediate storage. | `string` | `null` | no |
| <a name="input_semantic_max_tokens"></a> [semantic\_max\_tokens](#input\_semantic\_max\_tokens) | The maximum number of tokens a chunk can contain. | `string` | `null` | no |
